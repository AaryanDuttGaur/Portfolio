...
const Footer = () => {
  ...
  return (
    <footer className="bg-gradient-to-b from-red-600 to-red-900 rounded-t-[50px] px-5 py-10 text-white">
      <div className="max-w-4xl mx-auto">
        <div className="flex flex-wrap justify-center md:justify-evenly items-center gap-11 md:gap-12">
            ...
            <nav className="flex flex-row flex-wrap justify-center md:justify-start gap-2 md:gap-3">
              {navigationLinks.map((link, index) => (
                <Link
                  key={index}
                  href={link.href}
                  className="montserrat text-white text-[10px] hover:underline transition-all duration-300"
                >
                  {link.name}
                </Link>
              ))}
